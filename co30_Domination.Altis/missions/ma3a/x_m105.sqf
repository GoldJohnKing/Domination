...
// clear land mines
// marker (d_sm_105) somewhere on the crossroads (road), where mines will spawn

d_x_sm_pos = "d_sm_105" call d_fnc_smmapos; 
...
if (isServer) then {
	...
	sleep 2.123;
	["specops", 4, "allmen", 4, d_x_sm_pos # 0, 150, true] spawn d_fnc_CreateInf;
	sleep 2.123;
