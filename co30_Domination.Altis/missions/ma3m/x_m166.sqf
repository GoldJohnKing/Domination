...
d_x_sm_pos = "d_sm_166" call d_fnc_smmapos; //  sabotage submarine
...
if (isServer) then {
	...
	_vehicle setDir markerDir "d_sm_166";
	...
	sleep 2.123;
	["DSHKM",1,"AGS",0,"DSHKM",1,[_pos_other, 50] call d_fnc_GetRanPointCircleOuter,1,100,false] spawn d_fnc_CreateArmor;
	sleep 2.123;
