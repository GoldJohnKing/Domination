...
d_x_sm_pos = "d_sm_129" call d_fnc_smmapos; // Officer in camp, second array = pos aa
...
if (isServer) then {
	...
	_fortress setDir (markerDir "d_sm_129");
	...
	sleep 2.123;
	["specops", 5, "allmen", 2, _poss, 300, true] spawn d_fnc_CreateInf;
	sleep 2.123;
