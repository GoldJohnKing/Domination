...
d_x_sm_pos = "d_sm_9" call d_fnc_smmapos; // index: 9,   Plane prototype
d_x_sm_type = "normal"; // "convoy"

if (hasInterface) then {
	d_cur_sm_txt = localize "STR_DOM_MISSIONSTRING_878c";
	d_current_mission_resolved_text = localize "STR_DOM_MISSIONSTRING_821a";
};
...
if (isServer) then {
	...
	sleep 2.123;
	["specops", 1, "allmen", 3, _poss, 200, true] spawn d_fnc_CreateInf;
	sleep 2.111;
