...
d_x_sm_pos = "d_sm_4" call d_fnc_smmapos; // index: 4,   Cargo Box (chemical weapons) factory in Sagram
...
if (isServer) then {
	...
	sleep 2.123;
	["specops", 1, "allmen", 5, d_x_sm_pos # 1, 200, true] spawn d_fnc_CreateInf;
	sleep 2.123;
