...
d_x_sm_pos = "d_sm_11" call d_fnc_smmapos; // Find and eliminate Nib Nedal in the region around mount Bamjahan
...
if (isServer) then {
	...
	private _newpos = [_poss, 400] call d_fnc_GetRanPointCircle;
