...
d_x_sm_pos = "d_sm_4" call d_fnc_smmapos; // index: 4,   Water tower (chemical weapons) factory in Sagram
...
if (isServer) then {
	...
	sleep 2.123;
	["specops", 3, "allmen", 3, d_x_sm_pos # 1, 300, true] spawn d_fnc_CreateInf;
	sleep 2.123;
