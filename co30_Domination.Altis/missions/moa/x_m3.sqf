...
d_x_sm_pos = "d_sm_3" call d_fnc_smmapos; //  steal tank prototype, Timurkalay, array 2 and 3 = infantry and armor positions
...
if (isServer) then {
	...
	_vec setPos _poss;
	sleep 2.123;
	["specops", 4, "allmen", 3, d_x_sm_pos # 1, 250, true] spawn d_fnc_CreateInf;
	sleep 2.321;
