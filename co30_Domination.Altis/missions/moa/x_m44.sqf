...
d_x_sm_pos = "d_sm_44" call d_fnc_smmapos; // index: 44,   Steal chopper prototype near Zavark
...
if (isServer) then {
	...
	_vec setDir (markerDir "d_sm_44");
	_vec setPos _poss;
	sleep 2.123;
	["specops", 4, "allmen", 4, _poss, 200, true] spawn d_fnc_CreateInf;
	sleep 2.221;
