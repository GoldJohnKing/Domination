...
d_x_sm_pos = "d_sm_37" call d_fnc_smmapos; // index: 37,   Radar on Mont Tanoa
...
if (isServer) then {
	...
	sleep 2.132;
	["specops", 1, "allmen", 5, _poss, 50, true] spawn d_fnc_CreateInf;
	sleep 2.234;
	["aa", 1, "tracked_apc", 1, "tank", 1, d_x_sm_pos # 1, 1, 60, true] spawn d_fnc_CreateArmor;
};
