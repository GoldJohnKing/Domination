...
[{"[公告]服务器将于30分钟后重启!" remoteExecCall ["CBA_fnc_notify", -2];}, [], 19800] call CBA_fnc_waitAndExecute; // Restart Hint: -1800s 
...
[{"[公告]服务器将于30秒后重启!" remoteExecCall ["CBA_fnc_notify", -2];}, [], 21570] call CBA_fnc_waitAndExecute; // Restart Hint: -30s 
[{"btc_password" serverCommand "#restart";}, [], 21600] call CBA_fnc_waitAndExecute; // Restart every 6 hours 
