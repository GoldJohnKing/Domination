...
player addaction["2S3M1自行火炮: 需要6000荣誉",{["rhs_2s3_tv",6000]execvm "moneysystem\recrutesystem\buyvehicle .sqf";}];
player addaction["PLZ05自行火炮: 需要10000荣誉",{["O_PLZ05",10000]execvm "moneysystem\recrutesystem\buyvehicle .sqf";}];
