...
if (isServer) then {
	...
	private _choppers = [[d_chopper_1,3001,true,600],[d_chopper_2,3001,true,1500],[d_chopper_3,3003,false,600],[d_chopper_4,3001,false,600],[d_chopper_5,3004,false,600],[d_chopper_6,3001,false,600],[d_chopper_7,3004,false,600],[d_chopper_8,3001,false,600],[d_chopper_9,3003,false,600],[d_chopper_10,3001,false,600],[d_chopper_11,3004,false,600],[d_chopper_12,3003,false,600],[d_chopper_13,3001,false,600],[d_chopper_14,3001,false,600],[d_chopper_15,3003,false,600],[d_chopper_16,3003,false,600],[d_chopper_17,3003,false,600],[d_chopper_18,3003,false,600],[d_chopper_19,3004,false,600],[d_chopper_20,3001,false,600],[d_chopper_21,3001,false,600]] select {!isNil {_x # 0}}; // Edited: Change player vehicles
	...
	private _vecsar = [[d_vec_mhq_1,0,localize "STR_DOM_MISSIONSTRING_12"],[d_vec_mhq_2,1, localize "STR_DOM_MISSIONSTRING_13"],[d_vec_mhq_3,2, localize "STR_DOM_MISSIONSTRING_13A"],[d_vec_mhq_4,3, localize "STR_DOM_MISSIONSTRING_13B"],[d_vec_mhq_5,4, localize "STR_DOM_MISSIONSTRING_13C"],[d_vec_mhq_6,5, localize "STR_DOM_MISSIONSTRING_13D"],[d_vec_mhq_7,6, localize "STR_DOM_MISSIONSTRING_13E"],[d_vec_med_1,100],[d_vec_rep_1,200],[d_vec_fuel_1,201],[d_vec_ammo_1,202], [d_vec_rep_2,203],[d_vec_fuel_2,204], [d_vec_ammo_2,205], [d_vec_eng_1,300], [d_vec_eng_2,301], [d_vec_trans_1,400], [d_vec_trans_2,401],[d_vec_trans_3,402], [d_vec_trans_4,403], [d_vec_trans_5,404], [d_vec_trans_6,405], [d_vec_trans_7,406], [d_vec_trans_8,407],[d_vec_trans_9,408],[d_vec_trans_10,409],[d_vec_trans_11,410],[d_vec_trans_12,411],[d_vec_trans_13,412],[d_vec_trans_14,413],[d_vec_trans_15,414],[d_vec_trans_16,415],[d_vec_trans_17,416],[d_vec_trans_18,417],[d_vec_trans_19,418],[d_vec_trans_20,419],[d_vec_trans_21,420],[d_vec_trans_22,421],[d_vec_trans_23,422],[d_vec_trans_24,423],[d_vec_trans_25,424],[d_vec_trans_26,425],[d_vec_trans_27,426],[d_vec_trans_28,427],[d_vec_trans_29,428],[d_vec_trans_30,429],[d_vec_trans_31,430]] select {!isNil {_x # 0}};
	{
...
#else
	private _choppers = [[d_chopper_1,3001,true,600],[d_chopper_2,3002,true,600],[d_chopper_3,3003,false,600],[d_chopper_4,3004,false,600],[d_chopper_5,3005,false,600],[d_chopper_6,3006,false,600],
		[d_choppero_1,4001,true,600],[d_choppero_2,4002,true,600],[d_choppero_3,4003,false,600],[d_choppero_4,4004,false,600],[d_choppero_5,4005,false,600],[d_choppero_6,4006,false,600]] select {!isNil {_x # 0}};
...
if (hasInterface) then {
	...
	["d_teleporter_1", d_EFLAG_BASE,"ICON","ColorYellow",[1,1],localize "STR_DOM_MISSIONSTRING_6",0,"mil_flag"] call d_fnc_CreateMarkerLocal;
	{
		...
		"Start","d_chopper_serviceR","d_wreck_serviceR","d_teleporter_1","d_aircraft_serviceR","bonus_airR","bonus_vehiclesR","d_Ammobox ReloadR","Start_opfor","d_vehicle_serviceR", "d_runwaymarker_o", "d_runwaymarker","d_runwaymarker_1"];
#endif
