...
d_barracks_building = call {
	...
	if (isNil "d_ai_groups_respawn_time") then {
		...
		d_ai_groups_respawn_time = [400, 100, 300, 170];
	};
...
if (hasInterface) then {
	...
	call {
		...
		if (d_rhs) exitWith {//"rhs_btr80a_msv"
			["TCGM_Bike_nht","TCGM_Bike_snd","rhsusf_mrzr4_d","rhs_tigr_msv","rhs_tigr_m_msv","O_T_LSV_02_unarmed_F","O_T_LSV_02_AT_F","O_T_LSV_02_armed_F","B_LSV_01_unarmed_F","B_LSV_01_armed_F","B_LSV_01_AT_F","rhsusf_m1043_d_m2","rhsusf_m1043_d_mk19","rhsusf_m998_d_2dr_halftop","rhsusf_m1151_usarmy_d","rhsusf_m1152_usarmy_d","rhsusf_m1152_rsv_usarmy_d","rhsusf_m1151_m2_lras3_v1_usarmy_d","rhsusf_m1165a1_gmv_m2_m240_socom_d","rhsusf_m966_d","rhsusf_m1240a1_m240_usarmy_d","rhsusf_M1232_M2_usarmy_d","rhsusf_stryker_m1127_m2_d","rhsusf_stryker_m1132_m2_d","rhsusf_stryker_m1134_d","rhsusf_m113d_usarmy","rhsusf_m113d_usarmy_supply","rhs_brm1k_vdv","rhs_btr80a_msv","rhs_sprut_vdv","rhs_2s3_at_tv","rhsusf_m109d_usarmy","O_PLZ05","B_Truck_02_CAMM_ER_F","RHS_Stinger_AA_pod_D","rhs_Igla_AA_pod_msv","rhs_D30_at_msv","RHS_MELB_MH6M","RHS_MELB_H6M","RHS_UH60M_d","RHS_CH_47F_10","rhs_ka60_c","O_Heli_Light_02_dynamicLoadout_F","RHS_Mi8mt_vvsc"]
		};
		if (d_unsung) exitWith {
			["uns_willys"]
		};
