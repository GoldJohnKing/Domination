...
if (hasInterface) then {
	...
	call {
		...
		if (d_rhs) exitWith {
			["rhs_tigr_sts_msv", "AGE_LSV", "O_LSV_02_AT_F", "rhsgref_nat_uaz_spg9", "RHS_Ural_Ammo_MSV_01", "RHS_Ural_Repair_MSV_01", "RHS_Ural_Zu23_MSV_01", "O_Truck_02_medical_F", "rhsgref_BRDM2_ATGM_msv", "rhs_btr80a_vdv", "rhs_bmd4_vdv", "rhs_bmp2k_vdv", "rhs_bmp3m_msv", "rhs_sprut_vdv", "O_ZBL09", "O_ZTL11", "O_ZTD05","rhs_2s3_at_tv"]
		};
		if (d_ifa3lite) exitWith {
