...
switch (d_own_side) do {
	...
	case "WEST":  {
		["B_Heli_Attack_01_dynamicLoadout_F","RHS_M2A3_BUSKIII_wd",
		"rhs_t90sm_tv","rhs_t72be_tv","RHS_BM21_MSV_01","JS_JC_SU35",
		"rhsusf_m1a2sep1tuskiiwd_usarmy","rhsusf_m1a2sep2wd_usarmy",
		"C_Y_PLA_WZ10_F","RHS_Ka52_vvsc","rhs_mi28n_vvsc","rhsgref_b_mi24g_CAS",
