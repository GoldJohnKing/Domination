...
switch (d_own_side) do {
	...
	case "WEST":  {
		...
		"RHS_Ka52_vvsc","rhs_mi28n_vvsc","rhsgref_b_mi24g_CAS","O_Plane_Fighter_02_Stealth_F","B_APC_Tracked_01_AA_F","rhs_t90sab_tv",
		"O_Plane_CAS_02_dynamicLoadout_F","rhs_t80ue1","rhs_t15_tv","RHS_Mi24P_vdv","rhs_t90a_tv",
